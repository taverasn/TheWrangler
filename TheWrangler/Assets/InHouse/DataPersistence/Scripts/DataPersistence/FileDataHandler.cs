...
{
    // Directory file will be saved on computer
    ...
    public void DeleteAllProfiles()
    {
        ...
        {
            Debug.LogWarning("Persistent data path not found: " + persistentDataPath);
        }
    }
    ...
    public string GetMostRecentlyUpdatedProfileId()
    {
        ...
        foreach (KeyValuePair<string, GameData> pair in profilesGameData)
        {
            ...
            // if this is the first data we've come across that exists, its the most recent
    ...
    // the below is an implementation of XOR encryption
    ...
    private bool AttemptRollback(string fullPath)
    {
        ...
        try
        {
            ...
            // otherwise, we dont have a backup file - so theres nothing to roll back to
            else
            {
