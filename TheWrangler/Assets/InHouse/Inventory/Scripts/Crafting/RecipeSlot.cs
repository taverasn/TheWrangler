...
public class RecipeSlot : MonoBehaviour
{
    ...
    public void SetRecipe(RecipeSO recipeSO)
    {
        ...
        recipeName.text = recipeSO.item.displayName;
    ...
    public void UpdateRecipe(bool canCraft, List<Item> ingredients, bool canAddItem)
    {
        ...
        button.interactable = !canCraft || !canAddItem ? false : true;
    }
